package jp.ac.it_college.std.s22021.asyncsample
...
import jp.ac.it_college.std.s22021.asyncsample.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    @UiThread
    private fun receiveWetherInfo(q: String) {
