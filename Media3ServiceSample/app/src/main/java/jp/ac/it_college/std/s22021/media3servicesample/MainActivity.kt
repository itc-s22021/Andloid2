package jp.ac.it_college.std.s22021.media3servicesample
...
import jp.ac.it_college.std.nakasone.media3_service_sample.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun playSample() {
        ...
        controller.setMediaItem(
            MediaItem.fromUri("android.resource://${packageName}/${R.raw.harbour}")
        )
