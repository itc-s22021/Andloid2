package jp.ac.it_college.std.s22021.mediasample
...
import jp.ac.it_college.std.s22021.mediasample.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mediaFileUri = Uri.parse(
            "android.resource://${packageName}/${R.raw.sound2}"
        )
        mediaPlayer?.apply {
